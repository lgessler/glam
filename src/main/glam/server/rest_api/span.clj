...
(defn create-span [{{{:keys [value layer tokens]} :body} :parameters parser :pathom-parser  :as req}]
...
(defn get-span [{{{:keys [id]} :path} :parameters parser :pathom-parser :as req}]
...
(defn delete-span [{{{:keys [id]} :path} :parameters parser :pathom-parser  :as req}]
...
(defn patch-span [{{{:keys [id]} :path
                    {:keys [action value tokens]} :body} :parameters
